...
class GMailTests(unittest.TestCase):
    ...
    def test_send_mail(self):
        ...
        self.wait.until(
            EC.visibility_of_element_located(
                (By.XPATH, '//*[@id=":9l"]'))).send_keys(subject)

        driver.find_element_by_xpath('//*[@id=":9l"]').send_keys(subject)
        ...
        driver.find_element_by_id(":an").send_keys("Come on you young sailor men listen to me,\n"
                                                   "I'll sing you a song of the fish in the sea")
        driver.find_element_by_xpath('.//*[@id=":9b"]').click()
        print('Done')